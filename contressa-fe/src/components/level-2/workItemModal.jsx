  ...
  return (
    <div>
      ...
      >
        <div
          style={style}
          className="overflow-hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full bg-white border-2 border-black shadow-xl p-4 h-[95%]"
        >
          ...
          <PanelGroup direction="horizontal" className="flex gap-4 h-full w-full pb-10 ">
