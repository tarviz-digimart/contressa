...
function ChartColumn({ columnName, items, id }) {
    ...
    return (
        <div className='w-[25%] bg-[#f1f1f1] h-full flex flex-col items-start justify-start rounded-md p-2' ref={setNodeRef}
        ...
        >
            ...
            <div className='flex flex-col items-start justify-start gap-y-6 py-1 w-full'>
